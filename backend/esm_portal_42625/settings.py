"""
Django settings for esm_portal_42625 project.
...
INSTALLED_APPS = [
    ...
    'django.contrib.sites', "listing", "service"
]
LOCAL_APPS = [
    'home',
...
ROOT_URLCONF = 'esm_portal_42625.urls'
...
WSGI_APPLICATION = 'esm_portal_42625.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "esm_portal_42625 API",
    "DESCRIPTION": "API documentation for esm_portal_42625 App",
    "VERSION": "v1",
}
